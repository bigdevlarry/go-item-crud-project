                  ...
                  <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-6">
                      ...
                      <input
                        ...
                        required
                      />
                      <p v-if="!validateAccountNumber(formData.attributes.debtor.account.account_number) && formData.attributes.debtor.account.account_number !== ''" class="mt-1 text-sm text-red-600">Account number must be 1-8 digits</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-6">
                      ...
                      <input
                        ...
                        required
                      />
                      <p v-if="!validateAccountNumber(formData.attributes.beneficiary.account.account_number) && formData.attributes.beneficiary.account.account_number !== ''" class="mt-1 text-sm text-red-600">Account number must be 1-8 digits</p>
                    </div>
                  </div>
                </div>
              </div>
